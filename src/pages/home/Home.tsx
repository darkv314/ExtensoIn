                ...
                <section id="works" className="second__section">
                    ...
                    <div className="second__section__content">
                        <div className="second__section__content__item">
                            ...
                            <p>
                                Crea tu perfil y destaca tus habilidades,
                        ...
                        <div className="second__section__content__item">
                            ...
                            <p>
                                Explora las ofertas de empleo y aplica a las que
                                más se ajusten a tus intereses.
                            </p>
                        </div>
                        <div className="second__section__content__item">
                            <h3>3. ¡Listo!</h3>
                            <p>
                                Espera a que los empleadores se contacten
                                contigo para una entrevista.
                            </p>
                        </div>
                    </div>
                </section>
